#Followed along tej seth's code 
...
log_fg <- glm(made_fg ~ kick_distance, data = field_goals, 
              family = "binomial")
...
field_goals %>% 
  ...
  geom_point(aes(y = made_fg, color = ifelse(made_fg == 1, "darkgreen", "darkred")), alpha = 0.3) +
